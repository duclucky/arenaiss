...
export function EvaluationRunDetail() {
  ...
  return <section className="mx-auto max-w-4xl space-y-8">
    ...
    <header><p className="page-kicker">Public run record</p><h1 className="page-title">Test result</h1><p className="mt-4 break-all font-mono text-xs">{run.runId}</p></header>
