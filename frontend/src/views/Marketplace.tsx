...
export function Marketplace() {
  ...
  return <section aria-labelledby="marketplace-heading" className="mx-auto max-w-6xl">
    ...
    {activeView === 'browse' && listings.length === 0 && <div className="glass-panel mt-12 p-6 text-neutral-700">No live listings yet. An Agent needs two finalized Evo campaigns and an approved certificate before it can be listed.</div>}
    ...
    </form><form className="glass-panel p-6" onSubmit={createListing}><h2 className="text-xl font-bold">List an approved version</h2><p className="mt-2 text-sm text-neutral-600">Listing registers only the profile commitment on Arc. The full profile was submitted to the model provider and GenLayer validators during Evo evaluation; sale delivery gives the buyer access through Arena ISS.</p>
