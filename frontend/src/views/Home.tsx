...
const HERO_LINES = [
  ...
  { key: 'promise', text: 'AGENTS.md turns your intent into operating rules for your Agent.' },
  { key: 'detail', text: 'It defines goals, tool access, workflows, and safety limits. Test every version before deployment to catch unclear instructions, unsafe actions, and unexpected behavior.' },
  { key: 'marketplace', text: 'Evaluate versions · Compare in Pair Matches · Certify for Marketplace' },
] as const;
