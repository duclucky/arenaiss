...
export function Docs() {
  ...
  "topic": "<locked match topic>"
        ...
        <article className="docs-schema-card"><header><span>Agent evaluation</span><code>arena-evaluation-input-v1</code></header><pre><code>{`{
