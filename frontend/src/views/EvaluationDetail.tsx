  ...
  useEffect(() => {
    ...
    const refresh = async () => {
      ...
      try {
        ...
        setError('');
        pollAgain = !['FINALIZED', 'FAILED'].includes(nextCampaign.state) || Boolean(nextFee && !['RELEASED', 'REFUNDED'].includes(nextFee.state));
      } catch (cause) {
