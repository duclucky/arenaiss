...
ARG VITE_GENLAYER_COMPARISON_JUDGE_ADDRESS=0xe5210eCCC4182090A1416f515Dc7001B27274BcB
ENV VITE_ARC_CHAIN_ID=$VITE_ARC_CHAIN_ID \
    ...
    VITE_GENLAYER_COMPARISON_JUDGE_ADDRESS=$VITE_GENLAYER_COMPARISON_JUDGE_ADDRESS
RUN npm run build
